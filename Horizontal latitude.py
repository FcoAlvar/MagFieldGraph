...
plt.plot(X_p, GraphA, 'r-', label='Horizontal intensity')
plt.plot(X_p, GraphB, 'b-', label='Theoretical intensity')

plt.legend()
#plt.title('Comparation calculated Horizontal magnetic field intensity vs teorical one')
#plt.xlabel('Latitude ISS')

# =============================================================================
# plt.xticks([1, 20, 40, 60, 80, 100, 120, 140, 160])
# =============================================================================
plt.xticks(rotation=90)
#plt.ylabel('Horizontal magnetic field intensity')
plt.show()