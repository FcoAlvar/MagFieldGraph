...
plt.plot(X_p, GraphA, 'r-', label='Total intensity')
plt.plot(X_p, GraphB, 'b-', label='Theoretical intensity')

plt.legend()
#plt.title('Comparation calculated total magnetic field intensity vs teorical one')
...
plt.ylabel('Total magnetic field intensity')
plt.show()